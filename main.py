...
def main(page:Page):
    ...
    column_bt=Column([Row([bt_7,bt_8,bt_9,bt_multi])
                        ,Row([bt_4,bt_5,bt_6,bt_divide])
                        ,Row([bt_1,bt_2,bt_3,bt_plus])
                        ,Row([bt_c,bt_0,bt_equal,bt_minus])])
    ...
    main_con=Container(border_radius=10,width=300,height=300,padding=5,margin=0,content=maincolumn,alignment=alignment.center,bgcolor=colors.AMBER_100)
    page.add(main_con)
